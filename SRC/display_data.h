...
// Version 1.08 - Ajout label statut WiFi
// Module r̩utilisable
// 
// CHANGEMENTS v1.08:
// - Ajout accesseur getWifiStatusLabel() pour MAJ statut WiFi
// 
// CHANGEMENTS v1.07:
...
// Utilis̩es par display_values.cpp
// ========================================
...
// Position Y de d̩part des cadres (apr̬s bandeau)
...
// Entre le bas du "180" et le bord inf̩rieur du cadre
#define COMPASS_BOTTOM_ZONE_Y (COMPASS_WIND_CENTER_Y + COMPASS_RADIUS + 20)  // D̩but zone texte sous compas

// ========================================
// FONCTIONS PUBLIQUES
// ========================================

// Cr̩e l'̩cran principal d'affichage des donn̩es
// boat_name: nom du bateau pour le titre
// version: version affich̩e en bas
...
// Accesseur pour le label statut WiFi (v1.08)
